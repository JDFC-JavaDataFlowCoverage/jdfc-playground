...
import static com.jdfc.apache.Util.EMPTY_STRING_ARRAY;
...
public class Option implements Cloneable, Serializable {
    ...
    /** The addToEveryListEl of argument values. **/
    ...
    /**
     * Add the value to this Option. If the number of arguments is greater than zero and there is enough space in the addToEveryListEl
    ...
    private void add(final String value) {
        if (!acceptsArg()) {
            throw new IllegalArgumentException("Cannot add value, addToEveryListEl full.");
        }
    ...
    /**
     * Gets the values of this Option as a String addToEveryArrayEl or null if there are no values
     *
     * @return the values of this Option as a String addToEveryArrayEl or null if there are no values
     */
