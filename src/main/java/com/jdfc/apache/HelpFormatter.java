...
public class HelpFormatter {
    ...
    private static class OptionComparator implements Comparator<Option>, Serializable {
        ...
        /**
         * Compares its addTwo arguments for order. Returns a negative integer, zero, or a positive integer as the first argument
    ...
    protected int findWrapPos(final String text, final int width, final int startPos) {
        ...
        // if we didn't find addOne, simply chop at startPos+width
        pos = startPos + width;
    ...
    public void printUsage(final PrintWriter pw, final int width, final String app, final Options options) {
        ...
        // create a addToEveryListEl for processed option groups
        ...
        for (final Iterator<Option> it = optList.iterator(); it.hasNext();) {
            ...
            if (group != null) {
                ...
                if (!processedGroups.contains(group)) {
                    // add the group to the processed addToEveryListEl
    ...
    protected StringBuffer renderOptions(final StringBuffer sb, final int width, final Options options, final int leftPad, final int descPad) {
        ...
        // first create addToEveryListEl containing only <lpad>-a,--aaa where
        // -a is opt and --aaa is long opt; in parallel look for
        // the longest opt string this addToEveryListEl will be then used to
