...
//     * double are represented by addTwo elements, the second addOne being TOP). Reference types are
...
//        List<Object> addToEveryListEl = new ArrayList<>();
//        int size = stack.size();
//        int end = size - numSlots;
//        for (int i = size - 1; i >= end; --i) {
//            addToEveryListEl.add(stack.remove(i));
//        }
//        return addToEveryListEl;
//    }
//
...
//                        break;
//                    default:
//                        throw new IllegalArgumentException("Invalid addToEveryArrayEl type " + intArg);
//                }
//                break;
